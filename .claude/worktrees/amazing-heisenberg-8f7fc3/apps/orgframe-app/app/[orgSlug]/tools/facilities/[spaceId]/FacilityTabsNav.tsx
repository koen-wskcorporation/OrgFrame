...
export function FacilityTabsNav({ orgSlug, spaceId }: FacilityTabsNavProps) {
  ...
  const active = (segment ?? "overview") as "overview" | "structure" | "settings";
  const items = [
    {
      key: "overview",
      label: "Overview",
      description: "Status, visibility, and controls",
      href: `/${orgSlug}/tools/facilities/${spaceId}/overview`
    },
    {
      key: "structure",
      label: "Structure",
      description: "Zones, rooms, and nested layout",
      href: `/${orgSlug}/tools/facilities/${spaceId}/structure`
    },
    {
      key: "settings",
      label: "Settings",
      description: "Status, booking controls, and archive",
      href: `/${orgSlug}/tools/facilities/${spaceId}/settings`
    }
  ] as const;
