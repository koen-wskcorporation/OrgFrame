      ...
      <Card>
        <CardHeader>
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <Button href={`/${orgSlug}/workspace/programs/${programId}/structure`} type="button" variant="secondary">
              Open structure
            </Button>
          </div>
        </CardHeader>
              ...
              return (
                <div className="ui-list-item" key={summary.team.id}>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Button href={`/${orgSlug}/workspace/programs/${programId}/structure?teamId=${summary.team.id}`} size="sm" type="button" variant="ghost">
                      Open in structure
                    </Button>
                  </div>
                </div>
