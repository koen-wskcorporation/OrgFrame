...
import { MetricWidget } from "@/src/features/data-center/components/widgets/MetricWidget";
import { TimeseriesWidget } from "@/src/features/data-center/components/widgets/TimeseriesWidget";
import { BreakdownWidget } from "@/src/features/data-center/components/widgets/BreakdownWidget";
import { TableWidget } from "@/src/features/data-center/components/widgets/TableWidget";
import type { DataCenterLayout, DataCenterWidgetInstance } from "@/src/features/data-center/layout";
...
function renderWidget(widget: DataCenterWidgetInstance, source: ResolvedDataSource, snapshot: DataSourceSnapshot) {
  ...
  return (
    <TableWidget
      ...
      storageKey={`data-center:${source.fqKey}:table:${widget.refKey}`}
    />
  );
}
