import type { ButtonVariant, LinkValue, SiteButton } from "@/src/shared/links";
import { asButtonVariant, asLinkValue, createLocalId, defaultInternalLink, normalizeButtons } from "@/src/shared/links";
import type { CtaGridItem } from "@/src/features/site/types";
