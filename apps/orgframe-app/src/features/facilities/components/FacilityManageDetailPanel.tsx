...
import { Card, CardContent, CardDescription, CardHeader, CardHeaderRow, CardTitle } from "@orgframe/ui/primitives/card";
...
import { FacilityStructurePanel } from "@/src/features/facilities/components/FacilityStructurePanel";
        ...
        <Card>
          <CardHeader>
            <CardHeaderRow
              ...
              description={`${currentSelectedSpace.spaceKind} · ${currentSelectedSpace.timezone}`}
              title={currentSelectedSpace.name}
            />
          </CardHeader>
          <CardContent>
      ...
      {activeSection === "settings" ? (
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button href="/tools/facilities" size="sm" variant="secondary">
                Back to facilities
              </Button>
              <Button
