...
import { formatDateLabel, formatNumberCompact } from "@/src/features/data/components/widgets/format";
import type { SeriesDef } from "@/src/features/data/registry/types";
