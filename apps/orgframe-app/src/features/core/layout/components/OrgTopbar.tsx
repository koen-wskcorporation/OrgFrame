...
/**
 * Server component that owns the topbar's data fetching. Rendered
 * directly by [orgSlug]/layout.tsx — replaces the previous
 * @topbar parallel-route slot.
 */
export async function OrgTopbar({ orgSlug }: { orgSlug: string }) {
