...
import { ProgramEditorPanel } from "@orgframe/ui/modules/programs/components/ProgramEditorPanel";
import { ProgramPublishToggleButton } from "@orgframe/ui/modules/programs/components/ProgramPublishToggleButton";
...
import { ProgramTeamsPanel } from "@orgframe/ui/modules/programs/teams/components/ProgramTeamsPanel";
  ...
  const tabItems = [
    {
      ...
      href: `/${orgContext.orgSlug}/manage/programs/${details.program.id}/structure`
    },
    {
      key: "schedule",
      label: "Schedule",
      description: "Rules, sessions, and timeline",
      href: `/${orgContext.orgSlug}/manage/programs/${details.program.id}/schedule`
    },
    {
      key: "registration",
      label: "Registration",
      description: "Forms, eligibility, and intake",
      href: `/${orgContext.orgSlug}/manage/programs/${details.program.id}/registration`
    },
    {
      key: "teams",
      label: "Teams",
      description: "Roster and staff assignments",
      href: `/${orgContext.orgSlug}/manage/programs/${details.program.id}/teams`
    },
    {
      key: "settings",
      label: "Settings",
      description: "Metadata, media, and publish state",
      href: `/${orgContext.orgSlug}/manage/programs/${details.program.id}/settings`
    }
  ] as const;
  ...
  return (
    <PageStack>
      <PageHeader
        actions={
          <>
            <Button href={`/${orgContext.orgSlug}/manage/programs`} variant="secondary">
              Back to programs
            </Button>
